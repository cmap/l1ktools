...
class TestParseGCToox(unittest.TestCase):
	def test_get_all_id_values(self):
		...
		parse_gctoox.get_all_id_values(rid_dset, cid_dset, id_dict)
	...
	def test_get_ordered_slice_indexes(self):
		...
		parse_gctoox.get_ordered_slice_indexes("rids", test_dict, ['id4', 'id1', 'id2'])
	...
	def test_make_id_info_dict(self):
		...
		case1 = parse_gctoox.make_id_info_dict(rid_dset, cid_dset, None, None)
		...
		case2 = parse_gctoox.make_id_info_dict(rid_dset, cid_dset, ["218597_s_at"], None)
		...
		case3 = parse_gctoox.make_id_info_dict(rid_dset, cid_dset, None, ["LJP005_A375_24H:DMSO:-666"])
		...
		case4 = parse_gctoox.make_id_info_dict(rid_dset, cid_dset, ["218597_s_at"], ["LJP005_A375_24H:DMSO:-666"])
	...
	def test_set_slice_order(self):
		...
		(s1, f1) = parse_gctoox.set_slice_order(id_dict1)
		self.assertFalse(s1)
		self.assertEqual(f1, None)

		# case 2: rid slice only
		id_dict2 = parse_gctoox.make_id_info_dict(rid_dset, cid_dset,["200814_at", "218597_s_at"], None)
		(s2, f2) = parse_gctoox.set_slice_order(id_dict2)
		self.assertFalse(s2)
		self.assertEqual(f2, "rids")

		# case 3: cid slice only
		id_dict3 = parse_gctoox.make_id_info_dict(rid_dset, cid_dset,None, ["LJP005_A375_24H:DMSO:-666"])
		(s3, f3) = parse_gctoox.set_slice_order(id_dict3)
		self.assertFalse(s3)
		self.assertEqual(f3, "cids")

		# case 4: rid, cid slice
		id_dict4 = parse_gctoox.make_id_info_dict(rid_dset, cid_dset, ["200814_at", "218597_s_at"], ["LJP005_A375_24H:DMSO:-666"])
		(s4, f4) = parse_gctoox.set_slice_order(id_dict4)
		self.assertTrue(s4)
	...
	def test_parse_data_df(self):
		...
		id_dict1 = parse_gctoox.make_id_info_dict(rid_dset, cid_dset, None, None)
		case1 = parse_gctoox.parse_data_df(data_dset, id_dict1)
		...
		full_df2.index.name = "rid"
		full_df2.columns.name = "cid"
		id_dict2 = parse_gctoox.make_id_info_dict(rid_dset, cid_dset,["200814_at", "218597_s_at"], None)
		case2 = parse_gctoox.parse_data_df(data_dset, id_dict2)
		...
		full_df3.index.name = "rid"
		full_df3.columns.name = "cid"
		id_dict3 = parse_gctoox.make_id_info_dict(rid_dset, cid_dset,None, ["LJP005_A375_24H:DMSO:-666"])
		case3 = parse_gctoox.parse_data_df(data_dset, id_dict3)
		...
		full_df4.index.name = "rid"
		full_df4.columns.name = "cid"
		id_dict4 = parse_gctoox.make_id_info_dict(rid_dset, cid_dset, ["200814_at", "218597_s_at"], ["LJP005_A375_24H:DMSO:-666"])
		case4 = parse_gctoox.parse_data_df(data_dset, id_dict4)
	...
	def test_set_meta_index_to_use(self):
		...
		# case 1: full data frame
		id_dict1 = parse_gctoox.make_id_info_dict(rid_dset, cid_dset, None, None)
		(r1, v1) = parse_gctoox.set_meta_index_to_use("rids", id_dict1)	
		...
		# case 2: rid slice only
		id_dict2 = parse_gctoox.make_id_info_dict(rid_dset, cid_dset,["200814_at", "218597_s_at"], None)
		(r2, v2) = parse_gctoox.set_meta_index_to_use("rids", id_dict2)
		...
		# case 3: cid slice only
		id_dict3 = parse_gctoox.make_id_info_dict(rid_dset, cid_dset,None, ["LJP005_A375_24H:DMSO:-666"])
		(r3, v3) = parse_gctoox.set_meta_index_to_use("cids", id_dict3)
	...
	def test_populate_meta_array(self):
		...
		id_dict1 = parse_gctoox.make_id_info_dict(rid_dset, cid_dset, None, None)
		(r1a, v1a) = parse_gctoox.set_meta_index_to_use("rids", id_dict1)
		meta_df1a = parse_gctoox.populate_meta_array(row_meta_group, r1a)
		...
		(r1b, v1b) = parse_gctoox.set_meta_index_to_use("cids", id_dict1)
		meta_df1b = parse_gctoox.populate_meta_array(col_meta_group, r1b)
		...
		id_dict2 = parse_gctoox.make_id_info_dict(rid_dset, cid_dset,["200814_at", "218597_s_at"], None)
		(r2, v2) = parse_gctoox.set_meta_index_to_use("rids", id_dict2)
		meta_df2 = parse_gctoox.populate_meta_array(row_meta_group, r2)
		...
		id_dict3 = parse_gctoox.make_id_info_dict(rid_dset, cid_dset,None, ["LJP005_A375_24H:DMSO:-666"])
		(r3, v3) = parse_gctoox.set_meta_index_to_use("cids", id_dict3)
		meta_df3 = parse_gctoox.populate_meta_array(col_meta_group, r3)
	...
	def test_set_metadata_index_and_column_names(self):
		...
		# case 1: rows
		row_names_set = parse_gctoox.set_metadata_index_and_column_names("rids", mini_df1)
		...
		# case 2: cols
		col_names_set = parse_gctoox.set_metadata_index_and_column_names("cids", mini_df1)
