...
class TestWriteGCToo(unittest.TestCase):
    ...
    def test_write_top_half(self):
        ...
        f = open(fname, "wb")
        write_gctoo.write_top_half(f, self.row_metadata_df, self.col_metadata_df, "-666", "-666")
        f.close()
    ...
    def test_write_bottom_half(self):
        ...
        f = open(fname, "wb")
        write_gctoo.write_bottom_half(f, self.row_metadata_df, self.data_df, "NaN", "%.f", "-666")
        f.close()
    ...
    def test_l1000_functional(self):
        ...
        write_gctoo.write(l1000_in_gct, l1000_out_path)
